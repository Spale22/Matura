...
namespace Matura_Zadatak_A9
{
    public partial class Game : Form
    {
        ...
        SqlConnection conn = new SqlConnection(@"Data Source=192.168.0.20;Initial Catalog=A9;User ID=SA;Password=sp@sic123.");
        ...
        public Game()
        {
            ...
            pbGrb.ErrorImage = Image.FromFile(@"C:\Users\Velja\Desktop\Matura\A9\Matura\A9\Matura_Zadatak_A9\Matura_Zadatak_A9\Klubovi\no_image.jpg");
        }
            ...
            if (cbKlub.SelectedIndex != 0)
            {
                try
                {
                    ...
                    while (r.Read())
                    {
                        ...
                        pbGrb.Image = Image.FromFile(r[3].ToString());
                    }
                    r.Dispose();
                    comm.Dispose();
                }
